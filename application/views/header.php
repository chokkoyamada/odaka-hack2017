  ...
  <!-- 
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-xs-3">
					<div id="fh5co-logo"><a href="/pages/index">小高フレンドベース</a></div>
				</div>
				<div class="col-xs-9 text-right menu-1">
					<ul>
						<li class="active"><a href="/pages/index">トップページ</a></li>
						<li><a href="/pages/about">私たちについて</a></li>
						<li class="has-dropdown">
							<a href="services">ご利用案内</a>
							<ul class="dropdown">
								<li><a href="#">営業時間</a></li>
								<li><a href="#">メニュー</a></li>
								<li><a href="#">席の予約</a></li>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								...
								<li><a href="#">運営に参加する</a></li>
							</ul>
						</li>
						<li><a href="work.html">ライブカメラ</a></li>
